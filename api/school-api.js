// School-server PHP API proxy (cha_interview_db, *_gba tables only — fully
// isolated from the interview-bot project). Forwards raw UTF-8 bytes intact.
const SCHOOL_API_BASE = 'https://aiforalab.com/globalbiz-api/globalbiz-api.php'
